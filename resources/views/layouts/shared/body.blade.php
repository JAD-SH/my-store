...
<html lang="ar" dir="rtl">
  ...
  <body class="placeholder-glow">
    ...
    <button data-sos-once="true" data-sos="sos-left" class="h-auto btn btn-dark scroll-button-top scroll-button-to-hidden p-2 rounded-5 mx-auto" aria-label="go to top"><i class="fa-solid fa-angles-up fs-3 text-white fw-bolder"></i></button>
