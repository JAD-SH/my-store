<script src="{{asset('public/build/assets/js/core/jquery.js')}}"></script>
<script src="{{asset('public/build/assets/bootstrap/bootstrap.min.js')}}"></script>
<script src="{{asset('public/build/assets/js/animation-on-scroll.js')}}"></script>
<script src="{{asset('public/build/assets/js/script.js')}}"></script>
